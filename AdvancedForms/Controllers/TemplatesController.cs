...
[ApiController]
[Route("[controller]")]
public class TemplatesController : BaseCrudeController<PresetTemplate, PresetTemplateCreate, PresetTemplateUpdate>
{
	private readonly ITemplateService templateService;

	public TemplatesController(ITemplateService templateService, IFormService formService, IHttpContextAccessor httpContextAccessor) :
